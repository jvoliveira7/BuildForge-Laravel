...
<div class="min-h-screen bg-black text-white py-16">
    ...
    <div class="container mx-auto px-4">
        <h1 class="text-4xl font-bold text-orange-500 text-center mb-12 animate-fade-in-down">Todos os Produtos</h1>

        @if($produtos->count())
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
                @foreach ($produtos as $produto)
                    <div class="bg-gray-900 rounded-lg overflow-hidden shadow-lg transform hover:scale-105 hover:shadow-2xl transition duration-300 animate-fade-in">
